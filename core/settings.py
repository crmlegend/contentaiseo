...
# --- Database (SQLite on persistent path) ---
# Azure Linux App Service: code package is read-only; /home is writable & persistent.
# Set in Azure App Settings:  SQLITE_PATH=/home/data/app.db
...
# Ensure the directory exists BEFORE Django opens the DB file
...
MEDIA_URL = "/media/"
MEDIA_ROOT = os.getenv("MEDIA_ROOT", "/home/data/media")
os.makedirs(MEDIA_ROOT, exist_ok=True)  # ensure writable media dir exists
...
# --- Logging (to console for Azure Log Stream/Kudu) ---
LOGGING = {
    "version": 1,
    "disable_existing_loggers": False,
